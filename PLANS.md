...
- 公開: コミット `7c12f9f` を `main` へ push。GitHub Pages ワークフロー https://github.com/fooping-tech/TypeFab/actions/runs/35808833813 は success（`npm test` 204 件・build・デプロイ）。https://fooping-tech.github.io/TypeFab/app/ は HTTP 200 で、配信されるエディタの JS（`/TypeFab/assets/editor-D6rxDMpU.js`）に「フリーハンド」と `mobile-bar` を含む。
